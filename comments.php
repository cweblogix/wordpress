...
<p><input type="text" name="author" id="author" placeholder="Name*" size="22" tabindex="1" <?php if ($req) echo "aria-required='true'"; ?> /></p>

<p><input type="text" name="email" id="email" placeholder="Email*" size="22" tabindex="2" <?php if ($req) echo "aria-required='true'"; ?> /></p>

<p><input type="text" name="url" id="url" placeholder="Website" size="22" tabindex="3" /></p>
